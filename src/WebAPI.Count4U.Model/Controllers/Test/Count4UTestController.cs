...
namespace Count4U.Service.WebAPI.Model.Controllers
{
	...
	public class Count4UTestController : ControllerBase
	{
		private readonly ILogger<Count4UTestController> _logger;
		...
		{
			_logger = loggerFactory.CreateLogger<Count4UTestController>();
		...
		//[HttpGet("ado")]
		//public IEnumerable<string> GetCustomersADO()
		//{
